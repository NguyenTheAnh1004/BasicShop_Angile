/* js layout start */
	...
	function showCheckOut(){
		$.ajax({
			url: 'http://localhost/BasicShop_Angile/Ajax/showCheckOut',
			method: 'post',
			success: function(response){
	...
	function updateQuantity(productID,event){
		...
		$.ajax({
			url: 'http://localhost/BasicShop_Angile/Ajax/updateQuantity',
			method: 'post',
			data: {
				productID: productID,
	...
	function loadCartHover() {
		$.ajax({
			url: 'http://localhost/BasicShop_Angile/Ajax/loadCartHover',
			method: 'post',
			success: function(response) {
	...
	function loadCart() {
		$.ajax({
			url: 'http://localhost/BasicShop_Angile/Ajax/loadCart',
			method: 'post',
			success: function(response) {
	...
	function clearCart(){
		$.ajax({
			url: 'http://localhost/BasicShop_Angile/Ajax/clearCart',
		});
		loadCart();
		loadCartHover();
	}
	...
	function removeCart(){
		...
		$.ajax({
			url: 'http://localhost/BasicShop_Angile/Ajax/removeCart',
			method: 'post',
			data: {
				productID:productID
			},
	...
	function addCart(productID,quantity,type=1){
		$.ajax({
			url: 'http://localhost/BasicShop_Angile/Ajax/getSession',
			method: 'post',
			success: function(response) {
				if (response) {
					...
					$.ajax({
						url: 'http://localhost/BasicShop_Angile/Ajax/addCart',
						method: 'post',
						data: {
							productID:productID,
							quantity:_quantity
